...
export const dictionaries = {
  en: {
    ...
    matches: {
      ...
      penaltiesShort: "pens",
      penaltyWinnerPrompt: "If a draw, who wins on penalties?",
      goals: "goals",
      locked: "Locked",
      ...
      liveMatchBadge: "Live",
      doublePoints: "{multiplier}× points",
      save: "Save",
      saveAll: "Save all",
      fallbackTeam: "TBD",
      odds: "Odds",
    ...
    adminScoring: {
      ...
      knockoutMultiplier: "Knockout points multiplier",
  ...
  "pt-BR": {
    ...
    matches: {
      ...
      penaltiesShort: "pên.",
      penaltyWinnerPrompt: "Em caso de empate, quem vence nos pênaltis?",
      goals: "gols",
      locked: "Travado",
      viewLivePicks: "Ver palpites do grupo",
      pastMatches: "Jogos passados",
      liveMatches: "Ao vivo agora",
      liveMatchBadge: "Ao vivo",
      doublePoints: "{multiplier}× pontos",
      save: "Salvar",
      saveAll: "Salvar tudo",
    ...
    ranking: {
      ...
      rankingEvolution: "Evolução do ranking",
    ...
    adminScoring: {
      ...
      knockout: "Fase de mata-mata",
      knockoutMultiplier: "Multiplicador de pontos no mata-mata",
  ...
  es: {
    ...
    matches: {
      ...
      penaltiesShort: "pen.",
      penaltyWinnerPrompt: "En caso de empate, ¿quién gana en penales?",
      goals: "goles",
      locked: "Bloqueado",
      viewLivePicks: "Ver predicciones del grupo",
      pastMatches: "Partidos pasados",
      liveMatches: "En vivo ahora",
      liveMatchBadge: "En vivo",
      doublePoints: "{multiplier}× puntos",
      save: "Guardar",
    ...
    ranking: {
      ...
      rankingEvolution: "Evolución del ranking",
    ...
    adminScoring: {
      ...
      knockoutMultiplier: "Multiplicador de puntos en eliminatorias",
